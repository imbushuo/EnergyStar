...
New-CabinetFile -Name buildout.amd64.release.cab -ContentDirectory Package/buildout.amd64.release -DestinationDir ReleaseInvisible -DestinationPath Package
New-CabinetFile -Name buildout.arm64.release.cab -ContentDirectory Package/buildout.arm64.release -DestinationDir ReleaseInvisible -DestinationPath Package